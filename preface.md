...
書名叫《把機械的事情交給 AI 研究助理》。這個比喻要說清楚，因為它決定了整本書的每一個判斷。

**這條分界線不是我畫的。** 把機械的工作交出去、把判斷留下來，這個分法出自 Cheng-I Wu 的 [Academic Research Skills](https://github.com/Imbad0202/academic-research-skills)——他的原話是「AI is your copilot, not the pilot」，用的是飛航的比喻。本書改用研究助理，例子也全部落在教育研究，但那條分界線是他的。授權與完整血緣見書末〈出處〉。

研究助理可以幫你把文獻抓齊、可以幫你統一引用格式、可以在你漏看一個數字的時候指出來。但論文掛的是你的名字。你不會把助理交回來的初稿直接投出去，這一本書講的就是中間那段你該做什麼。

這句話有一個常見的誤讀，就是把它理解成「不要太相信 AI」。那個結論太廉價了。任何人都做得到不信任，代價是這個助理對你毫無用處。你把它當成打字機用，然後每一句都自己重寫一遍，那你不如不要用。
