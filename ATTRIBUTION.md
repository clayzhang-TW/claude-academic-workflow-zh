...
書末〈詞彙表〉的 59 條裡，有 **17 條標了 †**，意思是那個概念有外部來源。標記與本頁對應如下：

| † 的來源 | 詞彙表裡的條目 |
|---|---|
| AI Fluency 框架 | 4D 框架、Process（過程）、Performance（表現）、雙迴圈 |
| Academic Research Skills | 寫作模式鏈、材料缺口、修稿三輪、爆炸半徑、讓步稽核、答辯測驗 |
| Master-cai／彭思達 | 逆向大綱、主張與證據對照 |
| HKUSTDial | 五維度評分 |
| Creswell & Creswell (2018) | 研究取向、世界觀 |
| speak-human-tw | AI 腔 |
| shuorenhua | 保護片段 |

⚠️ **沒有 † 不等於「作者發明的」。** 另外 42 條裡，多數是領域通用說法或從實作裡長出來的形狀，只是沒有可指名的單一上游。
