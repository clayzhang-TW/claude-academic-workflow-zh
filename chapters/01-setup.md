...
這是第一章，所以這五題**不問你會不會，問你現在是什麼狀況**。花兩分鐘，照實答。

| # | 題目 | 你的答案 |
|---|---|---|
| **1** | 三個月前你跟 AI 討論過的某件事，你現在找得回來嗎？ | ⬜ 找得回來 ⬜ 找不到 |
| **2** | 你讀過的論文，除了 PDF 本身，還留下了什麼？ | ⬜ 有筆記且我會回頭看 ⬜ 只有 PDF |
| **3** | 你做過的研究決定（為什麼排除那批樣本、為什麼選這個方法），理由寫在哪裡？ | ⬜ 寫下來了 ⬜ 在腦子裡 |
| **4** | 同一份材料同時屬於兩三個主題時，你怎麼放？ | ⬜ 有辦法 ⬜ 選一個資料夾放，其餘只能靠記得 |
| **5** | 你分得出 Chat、Projects、Cowork、Code 各適合什麼嗎？ | ⬜ 說得出來 ⬜ 沒想過 |

**怎麼分流**

| 你的狀況 | 這一章對你是 |
|---|---|
| **右欄勾了 3 個以上** | **必要**。這一章要處理的正是那幾格，照順序讀 |
| **右欄勾 1–2 個** | 你已經有一半的現場了。跳到缺的那一節：第 1 題缺回 1.2、第 2 或第 4 題缺回 1.3、第 3 題缺回 1.3 末段、第 5 題缺回 1.4 |
| **右欄全空** | 這一章對你是**複習**。看 1.5 那三件事，然後直接進[第 2 章](../chapters/02-first-note.md) |

⚠️ **第 3 題右欄勾起來的人最多，而它的代價最晚出現**—— 通常是在你已經寫到方法章、卻想不起來當初為什麼那樣決定的時候。
...
〔教你的 Claude 建這個〕這一節的做法可以固定下來，而且現在就可以。

**先自己寫。** 開一個檔案，用你自己的話交代三件事——這是你的第一份說明檔：
...
| 檢查 | 為什麼 |
|---|---|
| 第一段寫的是**它猜不到的**東西嗎 | 「我是研究生」它猜得到，「我做國小生的 AI 素養量表」它猜不到 |
| 第三段有沒有寫「**不要幫我改寫**」 | 這一節剛講過：少了它，你拿到的是被潤飾過的文字，而你分不出哪裡原本有問題 |
| 整份是不是**短到你三十秒讀得完** | ⚠️ 第一版寫長沒有用。**它會長大，但不是今天** |

⚠️ **這裡最容易做錯的不是寫得不好，是寫得太完整。** 第三條擋的就是這件事。完整的做法在[第 3 章](../chapters/03-skills.md)。

**卡住超過十五分鐘再翻 → 〈範本對照冊〉第 3 則。**
...
> **〔補充〕上面三個理由有一個推論，現在先記著就好。** 你正在建的這個東西**不需要 AI 也不需要網路**。它是你硬碟上的一堆文字檔，斷網照開、換一台電腦照開、十年後也照開。這一點在本書後面會反覆出現：**這套工作流的骨幹是這個庫，AI 是接在它上面的加速器。** 完整的清點在[第 7 章](../chapters/07-revision-integrity.md) [7.5](../chapters/07-revision-integrity.md#75-帶著什麼離開)〈把它拿掉之後〉——那一節逐項列出流程裡哪些會停、哪些不會。
...
〔教你的 Claude 建這個〕**讓它幫你維護決策日誌。**

**先自己寫。** 這一份很短——它只要規定「每次追加一則的時候，你該做什麼」。三條就夠，而三條裡有兩條是**限制**不是任務。

**寫完之後，用這三條檢查：**

| 檢查 | 為什麼 |
|---|---|
| 理由欄空著或只寫「比較好」時，你要它**追問**還是**自己填** | 讓它自己填，你三個月後讀到的會是它的推測，而你會以為那是你當初想的 |
| 有沒有寫「**一律 append，不改既有的列**」 | 日誌的價值在於它記的是**當初**的理由，不是現在的 |
| 寫入之前，它要不要**先念給你看** | ⚠️ **這一條最容易漏，而它是三條裡最重要的。** 日誌是你日後推翻決定的依據，被悄悄改過就沒有用了 |

**卡住超過十五分鐘再翻 → 〈範本對照冊〉第 4 則。**
...
從這一章開始，每一章章末都有這一格。**現在填不出來是正常的**—— 你才剛開始，還沒有「上次」可言。

```text
本章的動作：把一段材料變成一份留得下來的東西
上次我完全不用它做這件事：____________
```

⚠️ **這一格不是要你少用。** 它防的是一件更安靜的事： **填不出日期，而你沒發現。** 這一章建的知識庫、決策日誌、那份說明檔——它們全都不需要 AI 才跑得動（1.3 那個〔補充〕講過）。所以這一格永遠填得出來，除非你已經很久沒有自己做過一次了。

[第 3 章](../chapters/03-skills.md) [3.5](../chapters/03-skills.md#35-讓它長大) 會把它變成你每個工具檔案的固定結尾。
