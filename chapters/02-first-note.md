...
〔動手一下〕**5 分鐘**。打開你的書目軟體，用「最近加入」列出十筆，只做一件事：把它們分成「值得跑流程」和「只記書目」兩堆。⚠️ 多數人第一次分完會發現**只記書目那一堆比想像的大**——那不是偷懶，那是 2.1 第 0 步在發揮作用。
