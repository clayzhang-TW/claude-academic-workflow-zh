...
[第 1 章](../chapters/01-setup.md)你已經親手抓過一筆假引用。但那是在可控的實驗裡，你**預期**它會出錯，而且只有五筆。真實情境不是那樣。真實情境是：你不預期、清單很長、時間不夠，而且你對每一筆都有一種模糊的熟悉感，因為你確實讀過那個領域的很多東西。
...
跑的人是[第 1 章](../chapters/01-setup.md)開場那位碩士生。收到指導教授兩行回信、被指出「你引的那兩篇我找不到」的那一位。他的題目是**同儕回饋對大學生寫作品質的影響**。這次他重做一遍，這次照流程走。

**這一節的每一步都給你三樣東西**：你實際要打什麼字、做對了會看到什麼、這一步最常在哪裡壞掉。你可以邊讀邊做，也可以先讀完再做。

〔補充〕下面的提示詞是**起點不是咒語**。它們寫得比較長，是因為[第 2 章](../chapters/02-first-note.md)那七個元素都塞進去了。你跑過兩三次之後一定會改它。那就對了，那是[第 4 章](../chapters/04-research-question.md)講的「從摩擦開始」。
...
**第四項是我後來才加的，也是最常命中的一項。** 一句主張底下擺了五段證據，看起來很厚實，攤開來發現五段出自同一個研究團隊的三篇論文—— 那不是五個獨立佐證，是一個。這跟[第 4 章](../chapters/04-research-question.md) [4.3](../chapters/04-research-question.md#43-文獻工作的三個瓶頸) 講的「重複命中不是獨立佐證」是同一件事，只是換到了你自己的稿子上。
...
這張圖畫的是[第 4 章](../chapters/04-research-question.md)與本章合起來的完整路徑。圖上前半（來源 → 轉檔 → 筆記 → 知識庫）在[第 4 章](../chapters/04-research-question.md)，後半（書目層 → 核實 → 引用）在本章。**綜整那一步在圖外**，因為它不屬於這條輸送帶—— 它是你在輸送帶末端做的判斷。
