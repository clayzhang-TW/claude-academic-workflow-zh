...
三種都不太像、但你還是覺得哪裡不對的時候，有一個更快的測法：**把那段綜整的結論反過來寫一次。** 「此議題仍具爭議」的反面是「此議題已有共識」，而你手上那二十篇筆記，多半兩句都撐得起來——撐得起來就表示那句結論是空的。真正的綜整反過來寫會立刻站不住。這個測法在 [7.2](../chapters/07-revision-integrity.md#72-投稿前自己審一遍) 有完整版。
...
表態不出來的時候，還有一條路：找一個會追問的對象，讓它一次問你一題，你答。答完那三句常常就在了。做法在[第 6 章](../chapters/06-analysis-writing.md) [6.3](../chapters/06-analysis-writing.md#63-寫作模式鏈)；這裡先記住順序——**先有主張，才輪到證據歸隊**。
...
**但有一件事在步驟一就可以請它做，而且不牴觸上面那句：讓它問你。** 界線是誰把主張講出來——「幫我列出三個發現」是它給你主張，「一次問我一題，我來答」是你給出主張，它只負責把問題問到你答不出四平八穩的話為止。前者你拿到的是二十篇的平均值，後者你拿到的是你自己本來就有、只是還沒講出口的判斷。[第 6 章](../chapters/06-analysis-writing.md) [6.3](../chapters/06-analysis-writing.md#63-寫作模式鏈) 有完整做法。
...
這正是前言講的研究助理定位：它擅長查表與挑毛病，不擅長替你決定要主張什麼。先讓你做完主張，再讓它來找漏洞。
...
〔動手一下〕**再花三分鐘，換一種問法。** 把那三句主張各自反過來寫成一個完整的、有人會相信的說法，然後只問自己一件事：我歸到那一格的證據，能不能反駁反面版本？反駁不了的那一句，問題不在證據不夠，在那句話本身沒有在說什麼。這個測法的完整版在 [7.2](../chapters/07-revision-integrity.md#72-投稿前自己審一遍)。
