...
⚠️ **同一篇文章還寫下了鷹架的失敗模式。** 六個鷹架功能裡的第五個是「挫折控制」，底下有一句：**最大的風險在於造成對教導者的過度依賴。** 提出這個概念的人，在提出它的同一頁就寫了這句話。 ⚠️ 而後續四十年的應用文獻，多半只引前四項。
...
- **van de Pol, J., Volman, M., & Beishuizen, J. (2010).** Scaffolding in teacher–student interaction: A decade of research. *Educational Psychology Review, 22*(3), 271–296. [https://doi.org/10.1007/s10648-010-9127-6](https://doi.org/10.1007/s10648-010-9127-6) 3.5 的〈也要寫退場〉那三個成分出自它，「用了支持策略不自動等於發生鷹架」那句話也是。 **開放取用。驗證層級：全文讀過。** ⚠️ **一個限制要一起知道，而且它比「這篇沒談 AI」更硬。** 那篇的文獻納入條件第六條明文寫著只收「**人的**鷹架，且為**面對面**接觸」—— 它是**從檢索階段就把非人的鷹架排除掉**，不是剛好沒收到。所以本書把三個成分拿來對照 AI，是**本書的延伸**，那篇對「工具能不能當鷹架」沒有任何主張，也沒有證據。 ⚠️ 順帶一提，它的效果結論只建立在 **8 篇**研究上，作者自己寫了「還需要更多研究」—— **引它來撐「鷹架有效」會超出它撐得住的強度**，那正是[第 5 章](../chapters/05-verification.md)在講的事。
