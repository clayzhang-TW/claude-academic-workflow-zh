...
⚠️ **撤太晚會出事，撤太早也會。** van de Pol 等人（2019）的研究發現，學生對支持的採納有時正是被**不合時宜的撤除**妨礙的；而先因應、再逐步撤除的支持最有效。所以〈退場〉那一節寫的是**條件**不是日期——「連續三次沒有實質差異」是條件，「三個月後停用」不是。
...
- **van de Pol, J., Volman, M., & Beishuizen, J. (2010).** Scaffolding in teacher–student interaction: A decade of research. *Educational Psychology Review, 22*(3), 271–296. [https://doi.org/10.1007/s10648-010-9127-6](https://doi.org/10.1007/s10648-010-9127-6) 3.5 的〈也要寫退場〉那三個成分出自它，「用了支持策略不自動等於發生鷹架」那句話也是。 **開放取用。驗證層級：全文讀過。** ⚠️ 一個限制要一起知道：**它回顧的是師生互動，不是人跟工具的互動。** 本書把三個成分拿來對照 AI，是**本書的延伸**，那篇沒有做過這件事。
- **van de Pol, J., Mercer, N., & Volman, M. (2019).** Scaffolding student understanding in small-group work. *Journal of the Learning Sciences.* [https://doi.org/10.1080/10508406.2018.1522258](https://doi.org/10.1080/10508406.2018.1522258) 「撤太早也會出事」出自它。**驗證層級：僅讀摘要**——本書只取方向，不取任何數值。
