...
一個極端的參照：[第 6 章](../chapters/06-analysis-writing.md) [6.3](../chapters/06-analysis-writing.md#63-寫作模式鏈) 那份動筆之前用的檔案，整份**零句在給東西**—— 它只被允許問、複述、標記你答不出來的地方。那不是因為它比較講究，是因為那個任務要的產出本來就不是文字，是你的一句主張。
...
- 比較順序：先自己做完再開檔案，不可反過來
- 上次裸做：____（空白就是警訊）
```

五行，寫完不用五分鐘。**回頭把它加到你已經建好的那幾個檔案，之後每建一個就寫一次。**

「比較順序」那一行看起來多餘，其實它撐著上面那個停用條件。**先看了它的版本才做自己的，你比的是自己能不能複述它，不是你們判得一不一樣。** 同樣的道理在 [7.2](../chapters/07-revision-integrity.md#72-投稿前自己審一遍) 會再出現一次，那裡管的是你自己的判斷穩不穩。
...
- **[第 1 章](../chapters/01-setup.md) [1.1](../chapters/01-setup.md#11-五分鐘之內跑完一次並留下結果)**：兩元素最小版。本章 3.2 把它展開成七個
