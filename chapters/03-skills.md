...
〔圖 3-3〕**位置有意義。** 越往右它自主性越高，越往上它越不需要你叫。連接器（connector）不在這兩條軸上。它不移動任何一格，它把整張圖**能碰到的範圍**變大。
...
〔圖 3-4〕同樣四樣東西，換一條軸看：**一次對話的時間軸。** 規則檔在你做任何事之前就已經載入了，連接器則要等到它真的需要碰外部程式。 **越早進場的，你越容易忘記它還在**。這正是規則檔要短的原因。
