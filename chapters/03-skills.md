...
〔圖 3-2〕有兩個地方要看。**第一，視窗裡越到後面，佔位置的主要是它自己的回答**，不是你講的話。你只打了兩行，它回了六百字。**第二，掉出去的是最早那幾句**，而最早那幾句通常正是你交代的限制與背景。
...
**刪的時候要留紀錄。** 在檔案底部寫一行「某月某日刪掉某條，理由是……」—— 理由跟第 1 章的決策日誌一樣：**你未來要推翻的是當初的理由，不是那條規則本身。**
