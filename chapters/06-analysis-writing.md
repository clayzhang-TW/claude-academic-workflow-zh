...
第 3 章教你建立自己的技能。第 4 章你用它跑文獻流程。本章 6.3 你會用它寫作。這些都是別人設計好的工具。
...
〔補充〕**這不會取代你讀書。** 你仍然需要理解那個方法在做什麼，否則你連問對問題都做不到。它取代的是「每次都要翻回去查那本書第 8 章第 3 節的那張表」這件事。判斷是你的，查表是它的。這正是本書從第 1 章講到現在的同一條界線。
...
- **Anthropic — Best practices for Claude Code**：[https://www.anthropic.com/engineering/claude-code-best-practices](https://www.anthropic.com/engineering/claude-code-best-practices) 雖然是寫給工程師的，但其中兩點跟本書完全重疊：**先研究再規劃、不要讓它直接動手**，以及多數最佳實務都源自同一個限制：脈絡會很快填滿，填滿之後品質下降。後者就是第 3 章 3.2。
