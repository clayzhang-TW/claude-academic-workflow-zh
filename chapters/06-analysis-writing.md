...
- 拿出一組查證過、而且標了驗證層級的筆記（[5.1](../chapters/05-verification.md#51-引用幻覺與四步核實)、[5.2](../chapters/05-verification.md#52-照著做一次從一篇-pdf-到一句你敢寫進論文的引用)）
- 說出四步核實**抓不到**什麼（[5.1](../chapters/05-verification.md#51-引用幻覺與四步核實)）
...
![圖 6-4 萃取結構，不是寫摘要](../resources/figures/fig6-4_萃取結構不是寫摘要.svg)

〔圖 6-4〕左邊那一團也是從同一本書來的。 **差別不在寫得好不好，在拆完之後還指不指得回原章**。
...
![圖 6-5 寫作模式鏈](../resources/figures/fig6-5_寫作模式鏈.svg)

〔圖 6-5〕六個階段攤成一條流程，右下角三條是使用規則。 **draft 那一格用紅框標出來**，因為它是唯一一個「它可能替你生出東西」的階段—— 下一小節整節在講那件事。
...
![圖 6-6 整理過的那份，不是拿來取代原稿的](../resources/figures/fig6-6_傾倒稿是唯一的對照組.svg)

〔圖 6-6〕去程一條、回程一條。**沒有那條回程線，左邊那一團就白倒了**—— 而回程線之所以容易被省掉，正是因為右邊那份讀起來已經很好。
...
第一題永遠是同一句：**如果全文只能放一句「我認為這個領域做錯了什麼」，你會寫哪一句？**
...
![圖 6-7 兩條路徑：你寫它潤，還是它問你答](../resources/figures/fig6-7_兩條路徑.svg)

〔圖 6-7〕上面那條是多數人的路徑，下面那條多了一段折返。 **折返那一段沒有產出任何文字**——它產出的是你自己也還沒講出口的那句話。

這就是這一節要講的事：**你在被問之前，其實不知道自己要主張什麼。** 不是想不出來，是還沒被逼著把它講成一句話。

[第 5 章](../chapters/05-verification.md) [5.3](../chapters/05-verification.md#53-從二十篇筆記到一個論點) 那個「不看筆記，先寫下你目前相信什麼」，用的是同一個原理，只是那裡靠你自己動手。這裡是找一個會追問的對象，處理你自己表態不出來的那一段。

〔動手一下〕**5 分鐘。** 挑你手上最卡的那一段，把上面那個第一題原封不動貼進去，要它只問這一題、不要給你任何段落。答完先不要往下走——看看你的答案跟你原本打算寫的那一段，是不是同一件事。

### 怎麼知道那是你的想法

⚠️ **這個做法的代價跟上一節那個一樣藏得很好**：**它會給你推薦答案，你一路照著點，最後拿到一份看起來是你的、實際上是它的主張。** 差別在於這一次連對照組都沒有——你沒有「原本倒出來的那一團」可以逐句對回去。

三條判準，第二條是主判準。

**第一條：它有沒有說出推薦答案的依據。** 「我建議選 A」跟「我建議選 A，因為你在第三節寫過某一句話」是兩種東西。沒有依據的推薦你反駁不了，只能同意或不同意——那不是訪談，是問卷。所以提示詞裡要把「講依據」寫成硬規定，不是請求。

**第二條：數你推翻過它幾次。** 一路照單全收，代表你在填問卷。這一條不必判斷、不必內省，你自己數得出來—— 跟[第 7 章](../chapters/07-revision-integrity.md) [7.5](../chapters/07-revision-integrity.md#75-帶著什麼離開) 那個「你上一次不用它做同一件事是什麼時候」是同一種判準，問的都是行為不是感覺。

沒有一個放諸四海的比例。但如果十題下來你一次都沒推翻過，先回頭看第一條：是它的推薦真的都對，還是它根本沒給你依據可以反駁。

**第三條：它有沒有複述你的答案。** 複述是給你校對的機會。實際跑起來，被當場更正的次數會超過你的預期—— 你以為你講清楚了，它複述出來卻是另一個意思，那表示你自己還沒講清楚。
...
第四條是這段話裡最重要的一條。少了它，你答不出來的地方會被補上一句通順的話，而那句話你事後看不出來不是你寫的。
...
![圖 6-8 三條判準，各自擋住不同的東西](../resources/figures/fig6-8_三條判準.svg)

〔圖 6-8〕三條判準擋的不是同一件事：第一條擋誘導，第二條擋順從，第三條擋誤解。**少了任何一條，另外兩條都還是會通過。**

三條判準管的是「這句話當下是不是我的」。它管不到另一件事：**幾週之後，那個主張還站不站得住。** 訪談問出來的立場，過一陣子回頭看常常會鬆動—— 不是因為你改變主意，是因為當初讓你點頭的那個理由，你已經想不起來了。投稿之前要再測一次，做法在 [7.2](../chapters/07-revision-integrity.md#72-投稿前自己審一遍)。
...
![圖 6-9 你在整條工作流的哪裡](../resources/figures/fig6-9_工作流地圖_W6.svg)
