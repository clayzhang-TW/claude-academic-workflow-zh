...
〔補充〕**這張表本身也是一份逐項判斷，所以它也會前後不一致。** 同一次協作，隔一週再自評一次，四格常常會給出不同的答案——而不同的原因通常不是你想通了什麼，是你這次剛好想到別的例子。要知道自己的自評穩不穩，做法跟 [7.2](../chapters/07-revision-integrity.md#72-投稿前自己審一遍) 那一段一樣：把上次的答案蓋起來再答一次。
