...
**五題，三分鐘。** 這是最後一章，所以第 5 題問的是**你這六章留下了什麼**。

| # | 題目 | 過關的樣子 |
|---|---|---|
| **1** | 拿出一份**你自己寫的**草稿，哪怕只有一節 | 你自己寫的，不是它起草你改的 |
| **2** | 說出統計那條責任邊界上，哪幾個判斷不能交出去 | 選模型、判資料品質、解讀為什麼——至少說得出兩個 |
| **3** | 你手上有**一份收過的審查意見或指導教授回饋** | 真的收過的，沒有的話用模擬版 |
| **4** | 說出「潤稿」跟「去 AI 腔」差在哪 | 你講得出兩者的目標不同，不是程度不同 |
| **5** | 打開你的技能庫，說出**哪一個檔案是你改過最多次的** | 說得出檔名，也說得出它為什麼一直被改 |

第 1、3 題是硬前置——這一章每一節都要你拿自己的東西來跑。 ⚠️ **第 5 題答不出來的人要注意**：本章 7.5 講的是「帶著什麼離開」，而你要帶走的正是那個一直被你改的檔案。

**怎麼分流**

| 過幾題 | 這一章你該怎麼讀 |
|---|---|
| **5 題** | 7.2（五角色自審）與 7.4（誠信框架）不可略，其餘看〈帶走這一節〉 |
| **3–4 題** | 正常讀 |
| **2 題以下** | ⚠️ **先回[第 6 章](../chapters/06-analysis-writing.md)**。缺第 1 題的人尤其——**沒有自己的草稿，這一章的每一個練習都只能看示範** |

---

## 章前導言

你手上這份初稿是[第 6 章](../chapters/06-analysis-writing.md)的產物。

這一章處理它離開你的手之前的最後幾件事，而「離開你的手」正是這一章所有內容的共同軸線。

回想[第 6 章](../chapters/06-analysis-writing.md)講的：AI 產出的初稿讀起來像成品，不像草稿。那個「像成品」的錯覺，在稿件即將寄出去的時候最危險，因為那是最後一個能攔住錯誤的位置。過了這個點，發現問題的就不是你了，是審查者、是讀者、是引用你的人。
...
〔教你的 Claude 建這個〕**讓它診斷，不要讓它改寫。**

這是第二輪唯一真正重要的設計決定，所以它必須是你自己想清楚的那一條。

**先自己寫。** 三件事：它只能做什麼、輸出長什麼樣、以及**動手之前要先列出什麼**。

**寫完之後，用這三條檢查：**

| 檢查 | 為什麼 |
|---|---|
| 有沒有寫「**只做診斷，不准直接改寫**」 | ⚠️ 讓它改，你會收到一段順的文字，**然後你不會知道它動了哪裡**。換湯、誤殺、被順手改掉的年份，全部藏在那段順裡面 |
| 動手前它要先列出**保護片段**嗎 | 數字與統計、構念與術語、引用與歸屬、引號內原文、量表題目。⚠️ **列完之後一律不碰**——動到已獲授權的量表題幹，該量表既有的效度證據就全部失效 |
| 輸出有幾欄？ | 位置｜這是哪一類問題｜**為什麼這一句有問題**。第三欄是你判斷它對不對的依據 |

⚠️ 記得反過來問它三件事：你的目標讀者是誰、稿子裡有沒有已獲授權的量表題目、你的領域有哪些**看起來像 AI 腔、實際上是規範寫法**的句型。

**卡住超過十五分鐘再翻 → 〈範本對照冊〉第 17 則。**
...
〔補充〕**這件事跟主張強度是同一件事的兩面。** 一份比對 2021 年人類書寫與 2025 年 AI 輔助書寫的研究指出（McKinley, 2026），學術寫作的立場標記會系統性偏移：第一人稱減少、緩和語減少、非人稱的斷言增加 ——「我認為」變成「研究證明」。緩和語減少、斷言增加，意思是 **你的主張強度被悄悄推高了**，而那正是[第 5 章](../chapters/05-verification.md) [5.2](../chapters/05-verification.md#52-照著做一次從一篇-pdf-到一句你敢寫進論文的引用) 第七步在防的事。所以「讀起來不像我」與「我講得比證據支撐的更滿」可能是同一個症狀。（出處與驗證層級見〈延伸資源〉。）
...
自審在工作流上是獨立的一站（本章末的圖 7-6，「送出」那一區亮起來的第二格），不是修稿順手做完的收尾動作。一站要成立，得說得出三件事。
...
![圖 7-1 要找的不是誰寫得最兇，是哪一段被指了三次](../resources/figures/fig7-1_重疊處才是訊號.svg)

〔圖 7-1〕五個角色各自獨立跑完，**看的是線的終點怎麼分布**。五份都跑完之後才並排看——你要找的是那個被指了不只一次的地方。

⚠️ 這是同一條規則的第三次出現。[第 4 章](../chapters/04-research-question.md) [4.3](../chapters/04-research-question.md#43-文獻工作的三個瓶頸) 說兩個資料庫都撈到，不算兩個獨立佐證；[第 5 章](../chapters/05-verification.md) [5.1](../chapters/05-verification.md#51-引用幻覺與四步核實) 說去驗的人不能是當初摘出那句話的人；這裡說**五個角色不能看見彼此**。7.3 還會出現第四次。理由每一次都一樣：**同一個角度看第二次，看到的還是同一個東西。**
...
〔教你的 Claude 建這個〕**一個角色一個檔案，不要一個檔案裝五個角色。**

這跟上一章的寫作模式剛好相反，**理由就是這一節的鐵則**：模式要路由所以合在一起，角色要獨立所以必須拆開。從**最有用的那一個**開始建，不要五個一起——通常是魔鬼代言人。

**先自己寫。** 它的工作只有一件：針對你的稿子寫出**最強的反論**，以及**你漏掉的替代解釋**。難的是那三條讓它不會軟掉的規則。

**寫完之後，用這三條檢查：**

| 檢查 | 為什麼 |
|---|---|
| 你反駁它的時候，它可以**直接讓步**嗎 | 要它先替你的反駁評分，四分以上才准讓步。⚠️ 沒有這一條，你只要說「我覺得沒問題」它就會同意 |
| 有沒有寫「**不准連續讓步**」 | 一次讓步之後它會傾向繼續讓，那時候它已經不是反方了 |
| 每次至少要提出一個**替代解釋**嗎 | 「你錯了」你可以反駁，「同一份資料還可以這樣解讀」你必須處理。⚠️ **後者才是審查者真正會問的形式** |

⚠️ 最後那一問是這個檔案唯一的祕密：**你這篇最怕被問的是哪一個問題？那個問題要它第一個問。** 你心裡已經有一個最怕被問的問題，而你八成正在繞過它。**先寫下來，就繞不掉了。**

**卡住超過十五分鐘再翻 → 〈範本對照冊〉第 18 則。**
...
如果你在 [6.3](../chapters/06-analysis-writing.md#63-寫作模式鏈) 動筆之前訂過一份標了字數的大綱，這一步還多一個用法：把逆向大綱抄出來的清單，跟當初那份大綱擺在一起。**兩份對不上的地方，就是你寫著寫著跑掉的那一節。** 而通常跑掉的不是結構，是某一節寫得比它該有的份量多了一倍，於是把旁邊那一節擠掉了。
...
處置只有一條，值得寫進你的技能檔：**需要新增引用的項目，一律標成「待查證」，在走完[第 5 章](../chapters/05-verification.md)那三層查證之前維持未解決。** 不要因為那個位置上已經有一個引用了就把它劃掉。劃掉的是問題，不是缺陷。
...
〔補充〕**新增引用的驗證**。在第三步修改稿件時，你可能會新增一些審查者要求的引用。這些新引用同樣要經過[第 5 章](../chapters/05-verification.md)的四步核實。AI 能幫你整理一份「本次修改中新增的所有引用」清單，讓你知道哪些需要去查。修稿的壓力和截止日期不是跳過核實的理由，恰好相反，趕時間的時候犯錯的機率更高。

〔補充〕這四步在成熟工作流裡會多三個關卡。 我自己的審稿回應工具在流程中途設了三個強制停點：意見分類之後問每條要怎麼處置、補跑統計**之前**問這個分析要不要跑、動筆之前問讓步範圍到哪裡。三個關卡落在同一種位置：這一步做下去就難回頭。其中第二個帶著一條硬規則。補跑的統計若結果不利於原結論，不得靜默不報。那條規則不是禮貌，是把誠信寫成機制。你的版本只需要一個關卡：找出流程裡「做錯了很難回頭」的那一步，在它前面插一個問句。關卡太多，你會養成整批略過的習慣，那時候等於一道都沒有。決策卡的四欄格式見[附錄 F](../appendix/F-skill-library.md) 的模式④。
...
![圖 7-2 改一個定義，四個方向會跟著動](../resources/figures/fig7-2_爆炸半徑.svg)

〔圖 7-2〕中間那一格有編號，你一定會改。**四個方向一個編號都沒有。**
...
〔教你的 Claude 建這個〕回應審查意見這件事，**關卡要設在流程中間，不是最後。**

**先自己寫。** 這一份要分**三個階段**，而且**每個階段結束都要停下來等你確認**。三階段大致是：拆解意見 → 你逐條決定 → 驗收你自己改完的東西。

**寫完之後，用這三條檢查：**

| 檢查 | 為什麼 |
|---|---|
| 第二階段（接受／部分接受／拒絕），它可以**替你決定**嗎 | 不行。它只能列出各選項的代價——⚠️ **那是你要對審查者負責的判斷** |
| 補跑的統計**不利於原結論**時，它要不要報 | ⚠️⚠️ **這一條是把誠信寫成機制，不是寫成期許。** 不寫進去，它會很自然地只報對你有利的那一半 |
| 第三階段它是**標記**還是**修改** | 只准標完整／部分／遺漏。它一動手改，驗收就變成了它在驗收自己 |

⚠️ 還有一條容易漏：**改到定義、構念、假設或統計時，要追四個方向的連帶**—— 上游前提、下游實作、詮釋回扣、摘要鏡像。改一個構念只改一處，留下的是一份自己跟自己打架的稿子。

**卡住超過十五分鐘再翻 → 〈範本對照冊〉第 19 則。**
...
![圖 7-3 判準就是那條線](../resources/figures/fig7-3_判準即分界線.svg)

〔圖 7-3〕**判準就是中間那條線。** 七章的每一件事，都被同一個問題分到左邊或右邊。左欄七格各不相同；右欄七格的性質完全一樣：機械、形式、可重複。所以第 7 章不再增加新的判準。它只是把前六章的位置並排放，讓你看見它們是同一條線。這不是七個獨立的提醒，是**同一個判準的七次應用**。
...
這也解釋了為什麼統計（[第 6 章](../chapters/06-analysis-writing.md)）是全書風險最高的一節：**它的錯誤最不容易浮出水面。**
...
規矩很簡單：貼任何錯誤訊息或執行紀錄之前，先自己掃一遍。而且這一條對**貼給同事**跟對貼給 AI 一樣成立。
...
這三層跟本節前面講的國際規範不是替代關係，是疊加的。國際規範管的是你投稿之後，在地規範管的是你的學位、你的計畫、你的職位。**兩邊都要看，而且衝突時以在地為準**，因為那一層有實際的處分權。連結見附錄 D-5。
...
[第 1 章](../chapters/01-setup.md)給了你一個三行版的最小聲明。現在講完整的。
...
- 統計（[第 6 章](../chapters/06-analysis-writing.md)）是全書風險最高的一節，因為它的錯誤最不容易浮出水面
...
![圖 7-4 關卡都長在同一條邊界上](../resources/figures/fig7-4_內外分界.svg)

〔圖 7-4〕**六道關卡全部長在同一條線上**。那條線就是「還在你手上」與「已經出去了」的分界。左邊那一欄從頭貫穿到尾：它不在任何一站上，但每一站都回來取用它。這張圖跟圖 7-3 是同一條線的兩個切面：**7-3 說判準是一條線，7-4 說那條線的實體位置在哪裡。**
...
![圖 7-5 三層起步，每層單獨成立](../resources/figures/fig7-5_三層起步.svg)
...
裝一個連接器（[3.4](../chapters/03-skills.md#34-提示詞技能代理)），讓它直接讀寫你的書目庫。換來的是 [4.5](../chapters/04-research-question.md#45-書目管理層讓機械工作歸機械) 那七步從手動變成批次，以及撤稿與被引極性的自動查核。
...
[第 6 章](../chapters/06-analysis-writing.md) [6.2](../chapters/06-analysis-writing.md#62-當你遇到不會的方法) 講的那條「工具會成長」的線，落實下來是一個很小的習慣：
...
| 五個問題拆解研究設計（[4.6](../chapters/04-research-question.md#46-這篇論文為什麼這樣做)） | **不受影響。** 書裡本來就寫著這一節不能交出去 |
| 四步核實與核實紀錄（[5.1](../chapters/05-verification.md#51-引用幻覺與四步核實)） | **不受影響。** 查資料庫、逐欄比對書目，本來就是你在做 |
| 綜整四步驟（[5.3](../chapters/05-verification.md#53-從二十篇筆記到一個論點)） | **成立。** 它在那一節的位置是反方，不是綜整者 |
...
這件事值得停下來想一下，因為它是這本書的兩條主線在這裡合起來：

> **可以交出去的那些事，也正是拿掉它之後你自己做得起來的事。**

反過來說也成立。你最不能委派的那幾件（決定主張、選模型、判斷替代解釋、拆解別人的設計），**恰好也是它不在的時候你照樣做得下去的那幾件**。這不是巧合，兩者是同一個性質的兩種說法：**需要你的學科判斷，所以交不出去，也所以不會因為它不在而消失。**
...
⚠️ **有一句要點名，因為它很容易被當成抱怨而略過：如果斷網半天你就完全做不下去，那不是網路的問題。** 那代表你的流程裡沒有一段是留在你自己手上的，而這件事不會等到斷網才有代價—— 它會在口試現場、在審查者追問「你為什麼這樣設計」的時候現形。
...
**還有一個更好的掛點：你自己的技能檔。** [3.5](../chapters/03-skills.md#35-讓它長大) 的〈也要寫退場〉要求每個檔案最下面留四行，其中一行是「上次裸做：____」。那個空格會在你每次打開檔案時看著你，比任何提醒都有效。⚠️ **如果你當時跳過了那一節，現在是回去補的時候**—— 你手上的檔案已經比那時候多了。
...
- **拆解別人的研究設計**（[4.6](../chapters/04-research-question.md#46-這篇論文為什麼這樣做)）。全書唯一一節明文寫著不能交出去
- **決定你的三句主張**（[5.3](../chapters/05-verification.md#53-從二十篇筆記到一個論點)）。它可以當反方，不能當作者
- **選模型、判資料品質**（[6.1](../chapters/06-analysis-writing.md#61-統計輔助的責任邊界)）。它的錯誤在這裡最不容易浮出水面
...
這就是[第 1 章](../chapters/01-setup.md)那句話最後一次出現：**如果它做錯了，我看得出來嗎？**
...
**週一**，她跑了[第 5 章](../chapters/05-verification.md) [5.3](../chapters/05-verification.md#53-從二十篇筆記到一個論點) 的四步驟。她寫下三句主張，把筆記片段歸進三個容器。其中一個容器幾乎是空的。她原本以為有很多證據支持的一個假設，實際上只有一篇直接研究。她決定把這個假設改成研究問題，而不是文獻回顧中的已確立結論。她還請 AI 當反方挑了一遍，被指出容器二的六篇論文裡有兩篇的研究設計跟她的情境差很大，引用的時候要加上但書。

**週二**，她用 draft 模式寫文獻回顧。她不是把十五篇的筆記全部貼進去，而是根據 [5.3](../chapters/05-verification.md#53-從二十篇筆記到一個論點) 歸類的結果，一次只餵一個容器的證據片段。第一個容器寫完，她看到兩處 `[MATERIAL GAP]` 標記：有兩段論證需要引用支持，但她沒有提供素材。她回到 Obsidian 翻閱，發現其中一處確實需要再找一篇論文，另一處其實不需要引用，只是她的表述方式讓 AI 以為需要。
...
這是最後一格，所以它問的不是這一章，是**整本書**。

```text
第 1 章的動作：把一段材料變成留得下來的東西    上次不用它：________
第 2 章的動作：把一篇論文讀成一份結構化筆記    上次不用它：________
第 3 章的動作：把一段重複的做法固定下來        上次不用它：________
第 4 章的動作：從別人的論文讀出它為什麼這樣設計 上次不用它：________
第 5 章的動作：把一筆引用查到我敢寫進論文      上次不用它：________
第 6 章的動作：把一段分析寫成人看得懂的段落    上次不用它：________
第 7 章的動作：判斷一條修改建議該不該接受      上次不用它：________
```

**七格填完，你會看到一件比任何自評量表都準的事：你的空格集中在哪裡。**

⚠️ **不是空格越少越好。** 第 1、2、3 章那幾格空著沒關係—— 那些本來就該交出去（7.4 的判準線右邊）。 **要盯的是第 4、5、6、7 章那四格**，因為它們全部落在判準線的左邊：拆解設計、查證詮釋、選模型、判斷修改建議。

那四格如果都填不出日期，你手上有的是一套很順的流程，以及一個逐漸判斷不了那套流程對不對的自己。

**這一格沒有及格線，因為它不是考試。它是一個你每隔一陣子會回來看的空白。**

![圖 7-6 你在整條工作流的哪裡](../resources/figures/fig7-6_工作流地圖_W7.svg)

〔圖 7-6〕亮起來的是這一章教的位置，淡掉的是你在別章會站上去的地方。最後三站的共同點只有一個：**產出即將離開你的手。** 那正是所有驗收關卡的位置（圖 7-4）。
...
- **[第 1 章](../chapters/01-setup.md)**：[1.5](../chapters/01-setup.md#15-在你往下走之前三件必須先知道的事) 那三件事已經告訴他，它會編造而且無法區分自己知道與不知道。心智模型校準之後，「四篇是真的所以這份清單是真的」這個推論不成立。而且那六篇不會留在對話裡，重要的東西要落成檔案；落檔的時候他就會發現，其中兩篇除了那一行書目之外，他手上什麼都沒有。
- **[第 2 章](../chapters/02-first-note.md)**：他親手抓過一次，所以「六篇裡有四篇我查得到」這件事本身對他就是一個訊號。而 [2.5](../chapters/02-first-note.md#25-最小查證三步) 那三步只花三十秒，那兩筆過不了第一步。
- **[第 3 章](../chapters/03-skills.md)**：他會發現自己從來沒把那兩篇的**內容**放進脈絡。[第 3 章](../chapters/03-skills.md)講過它只看得到你給的東西，而他給的只有 AI 自己產出的那一行書目。
- **[第 4 章](../chapters/04-research-question.md)**：[4.2](../chapters/04-research-question.md#42-該不該交給它) 的判讀要他逐一檢查成品、過程、表現三樣。他原本只檢查了成品——那六筆書目看起來都對。過程那一欄一問就破：他說不出那兩筆是怎麼被找出來的。
- **[第 5 章](../chapters/05-verification.md)**：四步核實，第一步 DOI 就解析不開。而且就算它僥倖通過，綜整的時候那兩筆沒有筆記可拆，根本進不了任何容器。
- **[第 6 章](../chapters/06-analysis-writing.md)**：draft 模式要他主動餵素材。那兩筆沒有素材可餵，段落會標出材料缺口——**它寧可告訴他少了東西，也不會自己補一個看起來合理的引用**。
- **第 7 章**：他的使用聲明要寫「引用如何核實」，寫的時候他會發現有兩筆他沒有核實過。

七道關卡，每一道都能單獨攔下同一個錯誤。這不是設計得多精巧，是因為**一個可靠的工作流本來就會有冗餘**。你不必每一步都做對，只要別每一步都跳過。

而他當初缺的不是謹慎。[第 1 章](../chapters/01-setup.md)就說了，那是知識問題不是態度問題。他缺的是一個正確的心智模型，加上一套會替他把關的流程。
...
1. 各自挑 7.2 五個角色裡的一個，只用那一副眼睛看對方的稿子，講十分鐘。挑到的角色最好是你自己不習慣的那一種。
2. 各自寫一份 AI 使用聲明再交換。對方那一份，有沒有哪一句你覺得寫得太滿，或太保守？
3. 「省下來的時間拿去做了什麼」——各自誠實回答一次。兩個答案放在一起，你們會給對方什麼建議？
...
工具換了，你花一個下午重新學操作就好。界線沒學會，換多少工具都一樣。
...
- **AI 對作者聲音的威脅（文獻回顧）**：Al Hosni, J. (2025). Preserving authorial voice in academic texts in the age of generative AI: A thematic literature review. *Arab World English Journal, 16*(3), 244–258. [https://doi.org/10.24093/awej/vol16no3.14](https://doi.org/10.24093/awej/vol16no3.14) 綜整 2023–2025 年十八篇研究。驗證層級：摘要層已核實，未讀全文；場域為 **ESL 大學寫作教學**。完整討論與量測方法見**[附錄 G](../appendix/G-writing-fingerprint.md)**。
...
- **APA Style — Citing generative AI**：[https://apastyle.apa.org/blog/cite-generative-ai-references](https://apastyle.apa.org/blog/cite-generative-ai-references) 教育研究最直接用得上的一份，區分「引用某一次對話」與「揭露工具使用」兩種情況。附錄 D-[3.5](../chapters/03-skills.md#35-讓它長大) 有完整對照。
...
**揭露與引用是兩件事，規則不同、後果也不同。** 引用格式錯了是編輯層的問題，改得回來；揭露不足是誠信層的問題，不一定。附錄 D-[3.5](../chapters/03-skills.md#35-讓它長大) 把兩者攤開對照。

**各期刊的規定不同且更新頻繁**，有的要求聲明、有的另有格式、有的對「用於資料分析」另設條款。 **投稿前一定要去看你那本期刊的作者須知**，不要照抄別篇論文的寫法，也不要照抄本書。

**本書其他章節**

- **[第 6 章](../chapters/06-analysis-writing.md)**：分析與撰寫。本章 7.1 修的就是那一章產出的初稿
- **[第 6 章](../chapters/06-analysis-writing.md) [6.2](../chapters/06-analysis-writing.md#62-當你遇到不會的方法)**：讓工具跟著研究長。7.5 的迭代習慣是它的日常版本
- **[附錄 A](../appendix/A-setup.md)**：安裝與設定（含技能的取得方式）
